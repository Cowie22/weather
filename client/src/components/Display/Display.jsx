...
const Display = (props) => {
  ...
  let forecastData = weatherData.consolidated_weather
    .slice(0, 5)
    .map((day, i) => {
      ...
      return (
        <Col className="forecast-col">
          <div
            className="inner-forecast-container"
            style={{ backgroundColor: color }}
            key={i}
          >
            <div className="day-container">
              <p className="text-center grey">{day.applicable_date.slice(5)}</p>
              <h4 className="text-center grey">{day.weather_state_name}</h4>
            </div>
            <Row>
              ...
              <Col lg={{ span: 5, offset: 1 }}>
                <div className="misc-weather-container">
                  ...
                  <p>Wind {(day.wind_speed * 0.621371).toFixed(0)}mph</p>
                </div>
              </Col>
            </Row>
          ...
          <Row>
            ...
            >
              <div className="inner-weather-container">
                <h2 className="gold text-center">{weatherData.title}</h2>
                <div className="forecast-container">{forecastData}</div>
              </div>
            </Fade>
          </Row>
        </Col>
